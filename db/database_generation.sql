...
ALTER TABLE BOOK ADD INDEX IF NOT EXISTS `TITLE_INDEX` (`BOOK_TITLE` ASC);
ALTER TABLE BOOK ADD INDEX IF NOT EXISTS `CATEGORY_INDEX` (`CATEGORY` ASC);
ALTER TABLE BOOK ADD INDEX IF NOT EXISTS `BOOK_PUBLISHER_FK_idx` (`PUBLISHER_NAME` ASC);
ALTER TABLE BOOK_AUTHORS ADD INDEX IF NOT EXISTS `AUTHOR_NAME_INDEX` (`AUTHOR_NAME` ASC);
